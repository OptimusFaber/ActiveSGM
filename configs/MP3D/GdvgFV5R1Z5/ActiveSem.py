...
if slam["method"] == "semsplatam":
    slam.update(
        room_cfg        = f"{dirs['cfg_dir']}/../mp3d_splatam_s.py",   # SplaTAM-s room configuration
...
##################################################
planner = dict(
    method= "active_gsv2",                           # planner method [predefined_traj, active_lang]
